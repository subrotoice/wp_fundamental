...
$settings           = array(
  ...
  'framework_title' => 'Theme Options <small>by Subroto</small>',
);
...
$options[]      = array(
  ...
  'fields'      => array(
	...
	array(
	  ...
	  'type'      => 'image',
	  'title'     => 'Logo Image',
	  'desc'      => 'Recommended size (MAX) : 190px x 60px.',
	  'help'      => 'Upload logo here',
	  'add_title' => 'Add Logo',
	),
	// end: a field
	array(
	  ...
	  'desc'      => '',
	  'help'      => 'Upload logo here',
	  'add_title' => 'Add Another Logo',
	),
	array(
	  'id'        => 'custom_favicon',
	  'type'      => 'image',
	  'title'     => 'Custom Favicon',
	  'desc'      => 'Recommended size .png/.ico : 32px x 32px.',
	  'help'      => 'Custom Favicon Upload',
	...
	array(
	  ...
	  'type'      => 'image',
	  'title'     => 'Custom Banner',
	  'desc'      => 'Recommended size .png/.ico : 720px x 90px.',
	  'help'      => 'Custom Banner Upload',
	...
	array(
	  ...
	  'type'  => 'textarea',
	  'title' => 'Header Code',
	  'desc'  => 'The following code will add to the <head> tag. Useful if you need to add additional codes such as CSS or JS.',
	...
	array(
	  ...
	  'type'  => 'textarea',
	  'title' => 'Footer Code',
	  'desc'  => 'The following code will add to the footer before the closing </body> tag. Useful if you need to add Javascript or tracking code.',
	  'info'      => 'Some information here for this option field.',
	),
...
// ----------------------------------------
// a option section for options ads  -
// ----------------------------------------
$options[]      = array(
  'name'        => 'adsSetting',
  'title'       => 'Ads Settings',
  ...
  'fields'      => array(
        array(
          ...
          'fields'    => array(
            ...
            array(
              'id'          => 'image_ads_top_banner_link',
              'type'        => 'text',
              'title'       => 'Top Banner Link',
            ),

            array(
              'id'          => 'image_ads_2_textarea',
              'type'        => 'text',
              'title'       => 'Alternative Text For The image',
            ),

          ),
          'default'   => array(
            'image_ads_2_textarea' => 'site image',
          )
        ),
        array(
          'id'        => 'fieldset_223',
          'type'      => 'fieldset',
          'title'     => 'Responsive Google AdSense',
          'fields'    => array(
            ...
            array(
              'id'          => 'googleads1',
              'type'        => 'textarea',
              'title'       => '728x90 (Leaderboard) - ad ID',
            ),

            array(
              'id'          => 'googleads2',
              'type'        => 'textarea',
              'title'       => '468x60 (Banner) - ad ID',
            ),
            array(
              'id'          => 'googleads3',
              'type'        => 'textarea',
              'title'       => '300x250 (Medium Rectangle) - ad ID',
            ),
            array(
              'id'          => 'googleads4',
              'type'        => 'textarea',
...
// ----------------------------------------
// a option section for options Style  -
// ----------------------------------------
$options[]      = array(
  'name'        => 'style',
  'title'       => 'Style',
  ...
  'fields'      => array(
		array(
		  'id'      => 'unique_option_30031',
		  'type'    => 'color_picker',
		  'before'   => '<h3>Background Color</h3>',
		  'title'   => 'Background color picker',
		  'default' => '#ffbc00',
		  'desc' => 'Pick color for background with Opacity',
		  'rgba'    => true,
		),
        array(
          'id'        => 'fieldset_22',
          ...
          'fields'    => array(
            ...
            array(
              'id'          => 'image_ads_top_banner_link',
              'type'        => 'textarea',
              'before'       => '<h3>Tablets:768 - 985px :</h3>',
			  'attributes'    => array(
				'placeholder' => 'Tablets:768 - 985px ',
				'rows'        => 10,
			  ),
            ),
            array(
              'id'          => 'image_ads_top_banner_link',
              'type'        => 'textarea',
              'before'       => '<h3>Wide Phones:480 - 767px :</h3>',
			  'attributes'    => array(
				'placeholder' => 'Wide Phones CSS',
				'rows'        => 10,
			  ),
            ),
            array(
              'id'          => 'image_ads_top_banner_link',
              'type'        => 'textarea',
              'before'       => '<h3>Phones:320 - 479px:</h3>',
			  'attributes'    => array(
				'placeholder' => 'Phone CSS',
				'rows'        => 10,
			  ),
            ),
...
// ----------------------------------------
// a option section for options Social Networking  -
// ----------------------------------------
$options[]      = array(
  'name'        => 'social',
  ...
  'fields'      => array(
				array(
				  'id'      => 'facebook_url', // another unique id
				  'type'    => 'text',
				  'title'   => 'Facebook URL',
				  'desc'    => 'Enter Facebook url',
				  'help'    => 'Social profile link',
				  'default' => 'https://facebook.com/subrotoice',
				),
				array(
				  'id'      => 'Twitter_URL', // another unique id
				  'type'    => 'text',
				  'title'   => 'Twitter URL',
				  'desc'    => 'Enter Twitter URL',
				  'help'    => 'Social profile link',
				  'default' => 'https://twitter.com/subrotoice',
				),
				array(
				  'id'      => 'Google_URL', // another unique id
				  'type'    => 'text',
				  'title'   => 'Google+ URL',
				  'desc'    => 'Enter Google+ URL',
				  'help'    => 'Social profile link',
				  'default' => 'https://plus.google.com/+subrotobiswas4u',
				),
				array(
				  'id'      => 'pastebin_url', // another unique id
				  'type'    => 'text',
				  'title'   => 'Pastebin URL',
				  'desc'    => 'Enter Pastebin url',
				  'help'    => 'Social profile link',
				  'default' => 'http://pastebin.com/u/subroto_ice',
				),
				array(
				  'id'      => 'github', // another unique id
				  'type'    => 'text',
				  'title'   => 'Github URL',
				  'desc'    => 'Enter Github url',
				  'help'    => 'Social profile link',
				  'default' => 'https://github.com/subrotoice',
				),
				array(
				  'id'      => 'LinkedIn_URL', // another unique id
				  'type'    => 'text',
				  'title'   => 'LinkedIn URL',
				...
				array(
				  'id'      => 'Dropbox_URL', // another unique id
				  'type'    => 'text',
				  'title'   => 'Dropbox URL',
				  'desc'    => 'Enter Dropbox url',
				  'help'    => 'Social profile link',
				),
  ), // end: fields
);
...
// ----------------------------------------
// a option section for options Footer Settings -
// ----------------------------------------
$options[]      = array(
  'name'        => 'footer',
  ...
  'fields'      => array(
			...
			array(
			  'id'        => 'bottom_footer_logo',
			  'type'      => 'image',
			  'title'     => 'Bottom Footer Logo',
			  'desc'      => '',
			  'help'      => 'Upload logo here',
			  'add_title' => 'Add Logo',
			),
            ...
            array(
              'id'          => 'Copyright_text',
              'type'        => 'textarea',
              'before'       => '<h3>CopyRight:</h3>',
              'after'       => '<p><strong>Variables</strong> These tags can be included in the textarea above and will be replaced when a page is displayed. </p>',
			  'attributes'    => array(
				'placeholder' => 'Copyright',
				'rows'        => 10,
			  ),
			  'default'       => 'Subroto © Copyright 2016, All Rights Reserved',
            ),
            array(
              'id'          => 'Footer_Text_Two',
              'type'        => 'textarea',
              'before'       => '<h3>Footer Text Two:</h3>',
              'after'       => '<p><strong>Variables</strong> These tags can be included in the textarea above and will be replaced when a page is displayed. </p>',
			  'attributes'    => array(
				'placeholder' => 'Copyright',
				'rows'        => 10,
			  ),
			  'default'       => 'Skype: subroto_ice 
Email: subroto.iu@gmail.com
Mobile: +8801722-272790',
            ),
  ), // end: fields
);
...
$options[]   = array(
  ...
  'fields'   => array(
    ...
    array(
      'type'    => 'heading',
      'content' => 'Theme Done by <a  target="_blank" href="http://www.subroto.net">Subroto Biswas</a>'
    ),
    array(
      'type'    => 'content',
      'content' => 'Feel free to contact: <br />Email: subroto.iu@gmail.com <br />Skype: subroto_ice <br />Mobile: +8801722-272790',
    ),
